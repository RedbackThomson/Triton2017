...
// Prepare the min.css for production (with 2 pipes to be sure that "triton.css" == "triton.min.css")
...
// Prepare the triton.css for the development environment
...
gulp.task('watch', function () {
    ...
    gulp.watch([basePaths.dev + 'js/**/*.js','js/**/*.js','!js/triton.js','!js/triton.min.js'], ['scripts']);
});
...
gulp.task('minify-css', function() {
  return gulp.src('./css/triton.css')
  .pipe(sourcemaps.init({loadMaps: true}))
